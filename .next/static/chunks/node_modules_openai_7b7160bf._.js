...
const ensurePresent = (value)=>{
    if (value == null) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Expected a value to be given but received ".concat(value, " instead."));
    }
    return value;
};
const validatePositiveInteger = (name, n)=>{
    if (typeof n !== 'number' || !Number.isInteger(n)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("".concat(name, " must be an integer"));
    }
    if (n < 0) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("".concat(name, " must be a positive integer"));
    }
    return n;
};
const coerceInteger = (value)=>{
    ...
    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Could not coerce ".concat(value, " (type: ").concat(typeof value, ") into a number"));
};
...
const getPlatformProperties = ()=>{
    ...
    if (detectedPlatform === 'node') {
        var _globalThis_process_platform, _globalThis_process_arch, _globalThis_process_version;
        return {
            'X-Stainless-Lang': 'js',
            'X-Stainless-Package-Version': __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$version$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VERSION"],
            'X-Stainless-OS': normalizePlatform((_globalThis_process_platform = globalThis.process.platform) !== null && _globalThis_process_platform !== void 0 ? _globalThis_process_platform : 'unknown'),
            'X-Stainless-Arch': normalizeArch((_globalThis_process_arch = globalThis.process.arch) !== null && _globalThis_process_arch !== void 0 ? _globalThis_process_arch : 'unknown'),
            'X-Stainless-Runtime': 'node',
            'X-Stainless-Runtime-Version': (_globalThis_process_version = globalThis.process.version) !== null && _globalThis_process_version !== void 0 ? _globalThis_process_version : 'unknown'
        };
    }
...
async function CancelReadableStream(stream) {
    ...
    if (stream[Symbol.asyncIterator]) {
        var _stream_Symbol_asyncIterator_return, _stream_Symbol_asyncIterator;
        await ((_stream_Symbol_asyncIterator_return = (_stream_Symbol_asyncIterator = stream[Symbol.asyncIterator]()).return) === null || _stream_Symbol_asyncIterator_return === void 0 ? void 0 : _stream_Symbol_asyncIterator_return.call(_stream_Symbol_asyncIterator));
        return;
    }
    const reader = stream.getReader();
    const cancelPromise = reader.cancel();
...
const FallbackEncoder = (param)=>{
    let { headers, body } = param;
    return {
        bodyHeaders: {
...
let has = (obj, key)=>{
    var _Object_hasOwn;
    return has = (_Object_hasOwn = Object.hasOwn) !== null && _Object_hasOwn !== void 0 ? _Object_hasOwn : Function.prototype.call.bind(Object.prototype.hasOwnProperty), has(obj, key);
};
...
const defaults = {
    ...
    serializeDate (date) {
        return (toISOString !== null && toISOString !== void 0 ? toISOString : toISOString = Function.prototype.call.bind(Date.prototype.toISOString))(date);
    },
    skipNulls: false,
...
function loggerFor(client) {
    ...
    const logLevel = (_client_logLevel = client.logLevel) !== null && _client_logLevel !== void 0 ? _client_logLevel : 'off';
    if (!logger) {
        return noopLogger;
    }
...
const formatRequestDetails = (details)=>{
    ...
    if (details.headers) {
        details.headers = Object.fromEntries((details.headers instanceof Headers ? [
            ...details.headers
        ] : Object.entries(details.headers)).map((param)=>{
...
async function defaultParseResponse(client, props) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loggerFor"])(client).debug("[".concat(requestLogID, "] response parsed"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRequestDetails"])({
        retryOfRequestLogID,
        url: response.url,
...
const checkFileSupport = ()=>{
    if (typeof File === 'undefined') {
        ...
        const isOldNode = typeof (process === null || process === void 0 ? void 0 : (_process_versions = process.versions) === null || _process_versions === void 0 ? void 0 : _process_versions.node) === 'string' && parseInt(process.versions.node.split('.')) < 20;
...
async function getBytes(value) {
    ...
    value instanceof ArrayBuffer) {
        ...
        const constructor = value === null || value === void 0 ? void 0 : (_value_constructor = value.constructor) === null || _value_constructor === void 0 ? void 0 : _value_constructor.name;
...
const createPathTagFunction = function() {
    let pathEncoder = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : encodeURIPath;
    return function path(statics) {
        ...
        const path = statics.reduce((previousValue, currentValue, index)=>{
            ...
            var _value_hasOwnProperty, _Object_getPrototypeOf1;
            if (index !== params.length && (value == null || typeof value === 'object' && // handle values from other realms
            value.toString === ((_Object_getPrototypeOf = Object.getPrototypeOf((_Object_getPrototypeOf1 = Object.getPrototypeOf((_value_hasOwnProperty = value.hasOwnProperty) !== null && _value_hasOwnProperty !== void 0 ? _value_hasOwnProperty : EMPTY)) !== null && _Object_getPrototypeOf1 !== void 0 ? _Object_getPrototypeOf1 : EMPTY)) === null || _Object_getPrototypeOf === void 0 ? void 0 : _Object_getPrototypeOf.toString))) {
                encoded = value + '';
        ...
        const invalidSegmentPattern = RegExp("(?<=^|\\/)(?:\\.|%2e){1,2}(?=\\/|$)", "gi");
        let match;
...
class Messages extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ list(completionID) {
        ...
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), completionID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options
        });
    }
...
function assertToolCallsAreChatCompletionFunctionToolCalls(toolCalls) {
    for (const toolCall of toolCalls || []){
        if (toolCall.type !== 'function') {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Currently only `function` tool calls are supported; Received `".concat(toolCall.type, "`"));
        }
    }
}
function validateInputTools(tools) {
    for (const tool of tools !== null && tools !== void 0 ? tools : []){
        if (tool.type !== 'function') {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Currently only `function` tool types support auto-parsing; Received `".concat(tool.type, "`"));
        }
        if (tool.function.strict !== true) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("The `".concat(tool.function.name, "` tool is not marked with `strict: true`. Only strict function tools can be auto-parsed"));
        }
    }
...
class EventStream {
    ...
    _emit(event) {
        ...
        if (event === 'abort') {
            const error = args[0];
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$tslib$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["__classPrivateFieldGet"])(this, _EventStream_catchingPromiseCreated, "f") && !(listeners === null || listeners === void 0 ? void 0 : listeners.length)) {
...
class AbstractChatCompletionRunner extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$EventStream$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventStream"] {
    ...
    async _runTools(client, params, options) {
        ...
        const singleFunctionToCall = typeof tool_choice !== 'string' && tool_choice.type === 'function' && (tool_choice === null || tool_choice === void 0 ? void 0 : (_tool_choice_function = tool_choice.function) === null || _tool_choice_function === void 0 ? void 0 : _tool_choice_function.name);
...
_AbstractChatCompletionRunner_instances = new WeakSet(), _AbstractChatCompletionRunner_getFinalContent = function _AbstractChatCompletionRunner_getFinalContent() {
    ...
    for(let i = this.messages.length - 1; i >= 0; i--){
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$chatCompletionUtils$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAssistantMessage"])(message) && (message === null || message === void 0 ? void 0 : (_message_tool_calls = message.tool_calls) === null || _message_tool_calls === void 0 ? void 0 : _message_tool_calls.length)) {
            var _message_tool_calls_filter_at;
            return (_message_tool_calls_filter_at = message.tool_calls.filter((x)=>x.type === 'function').at(-1)) === null || _message_tool_calls_filter_at === void 0 ? void 0 : _message_tool_calls_filter_at.function;
        }
    }
    return;
...
class ChatCompletionStream extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$AbstractChatCompletionRunner$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AbstractChatCompletionRunner"] {
    ...
    [(_ChatCompletionStream_params = new WeakMap(), _ChatCompletionStream_choiceEventStates = new WeakMap(), _ChatCompletionStream_currentChatCompletionSnapshot = new WeakMap(), _ChatCompletionStream_instances = new WeakSet(), _ChatCompletionStream_beginRequest = function _ChatCompletionStream_beginRequest() {
        ...
        if (toolCallSnapshot.type === 'function') {
            var __classPrivateFieldGet_tools, __classPrivateFieldGet;
            const inputTool = (__classPrivateFieldGet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$tslib$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["__classPrivateFieldGet"])(this, _ChatCompletionStream_params, "f")) === null || __classPrivateFieldGet === void 0 ? void 0 : (__classPrivateFieldGet_tools = __classPrivateFieldGet.tools) === null || __classPrivateFieldGet_tools === void 0 ? void 0 : __classPrivateFieldGet_tools.find((tool)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$parser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isChatCompletionFunctionTool"])(tool) && tool.function.name === toolCallSnapshot.function.name); // TS doesn't narrow based on isChatCompletionTool
        ...
        const responseFormat = (__classPrivateFieldGet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$tslib$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["__classPrivateFieldGet"])(this, _ChatCompletionStream_params, "f")) === null || __classPrivateFieldGet === void 0 ? void 0 : __classPrivateFieldGet.response_format;
...
function finalizeChatCompletion(snapshot, params) {
    ...
    const completion = {
        ...
        choices: choices.map((param)=>{
            ...
            if (!finish_reason) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing finish_reason for choice ".concat(index));
            }
            const { content = null, function_call, tool_calls, ...messageRest } = message;
            const role = message.role; // this is what we expect; in theory it could be different which would make our types a slight lie but would be fine.
            if (!role) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing role for choice ".concat(index));
            }
            if (function_call) {
                const { arguments: args, name } = function_call;
                if (args == null) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing function_call.arguments for choice ".concat(index));
                }
                if (!name) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing function_call.name for choice ".concat(index));
                }
                ...
                return {
                    ...
                    message: {
                        ...
                        tool_calls: tool_calls.map((tool_call, i)=>{
                            ...
                            if (id == null) {
                                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing choices[".concat(index, "].tool_calls[").concat(i, "].id\n").concat(str(snapshot)));
                            }
                            if (type == null) {
                                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing choices[".concat(index, "].tool_calls[").concat(i, "].type\n").concat(str(snapshot)));
                            }
                            if (name == null) {
                                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing choices[".concat(index, "].tool_calls[").concat(i, "].function.name\n").concat(str(snapshot)));
                            }
                            if (args == null) {
                                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing choices[".concat(index, "].tool_calls[").concat(i, "].function.arguments\n").concat(str(snapshot)));
                            }
                            return {
                                ...toolRest,
                                id,
...
class Completions extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(completionID, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), completionID), options);
    }
    /**
     ...
     */ update(completionID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), completionID), {
            body,
            ...options
        });
    }
     ...
     */ delete(completionID, options) {
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), completionID), options);
    }
    parse(body, options) {
...
class Batches extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(batchID, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), batchID), options);
    }
    /**
     ...
     */ cancel(batchID, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), batchID), options);
    }
...
class Assistants extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(assistantID, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), assistantID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ update(assistantID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), assistantID), {
            body,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ delete(assistantID, options) {
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), assistantID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
...
class Messages extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(threadID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), threadID), {
            body,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ retrieve(messageID, params, options) {
        ...
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), thread_id, messageID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ update(messageID, params, options) {
        ...
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), thread_id, messageID), {
            body,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ list(threadID) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject3(), threadID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ delete(messageID, params, options) {
        const { thread_id } = params;
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject4(), thread_id, messageID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
...
class Steps extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(stepID, params, options) {
        ...
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), thread_id, run_id, stepID), {
            query,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ list(runID, params, options) {
        ...
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), thread_id, runID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
...
const readEnv = (env)=>{
    if (typeof globalThis.process !== 'undefined') {
        var _globalThis_process_env_env, _globalThis_process_env;
        var _globalThis_process_env_env_trim;
        return (_globalThis_process_env_env_trim = (_globalThis_process_env = globalThis.process.env) === null || _globalThis_process_env === void 0 ? void 0 : (_globalThis_process_env_env = _globalThis_process_env[env]) === null || _globalThis_process_env_env === void 0 ? void 0 : _globalThis_process_env_env.trim()) !== null && _globalThis_process_env_env_trim !== void 0 ? _globalThis_process_env_env_trim : undefined;
    }
    if (typeof globalThis.Deno !== 'undefined') {
        var _globalThis_Deno_env_get, _globalThis_Deno_env_get1, _globalThis_Deno_env;
        return (_globalThis_Deno_env = globalThis.Deno.env) === null || _globalThis_Deno_env === void 0 ? void 0 : (_globalThis_Deno_env_get1 = _globalThis_Deno_env.get) === null || _globalThis_Deno_env_get1 === void 0 ? void 0 : (_globalThis_Deno_env_get = _globalThis_Deno_env_get1.call(_globalThis_Deno_env, env)) === null || _globalThis_Deno_env_get === void 0 ? void 0 : _globalThis_Deno_env_get.trim();
    }
    return undefined;
...
class Runs extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(runID, params, options) {
        const { thread_id } = params;
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), thread_id, runID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ update(runID, params, options) {
        const { thread_id, ...body } = params;
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), thread_id, runID), {
            body,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ cancel(runID, params, options) {
        const { thread_id } = params;
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject4(), thread_id, runID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ async poll(runId, params, options) {
        var _options_pollIntervalMs;
        var _options_pollIntervalMs_toString;
        const headers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
            options === null || options === void 0 ? void 0 : options.headers,
            {
                ...
                'X-Stainless-Custom-Poll-Interval': (_options_pollIntervalMs_toString = options === null || options === void 0 ? void 0 : (_options_pollIntervalMs = options.pollIntervalMs) === null || _options_pollIntervalMs === void 0 ? void 0 : _options_pollIntervalMs.toString()) !== null && _options_pollIntervalMs_toString !== void 0 ? _options_pollIntervalMs_toString : undefined
            }
        ]);
        while(true){
    ...
    submitToolOutputs(runID, params, options) {
        const { thread_id, ...body } = params;
        var _params_stream;
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject5(), thread_id, runID), {
            body,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
...
class Threads extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(threadID, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), threadID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ update(threadID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), threadID), {
            body,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ delete(threadID, options) {
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), threadID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
...
class Content extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(fileID, params, options) {
        ...
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), container_id, fileID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
...
class Files extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(containerID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), containerID), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$uploads$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["multipartFormRequestOptions"])({
            body,
            ...options
        }, this._client));
    }
     ...
     */ retrieve(fileID, params, options) {
        const { container_id } = params;
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), container_id, fileID), options);
    }
    /**
     * List Container files
     */ list(containerID) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), containerID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options
        });
    }
     ...
     */ delete(fileID, params, options) {
        const { container_id } = params;
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject3(), container_id, fileID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    Accept: '*/*'
...
class Containers extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(containerID, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), containerID), options);
    }
    /**
     * List Containers
     */ list() {
     ...
     */ delete(containerID, options) {
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), containerID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    Accept: '*/*'
...
class OutputItems extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(outputItemID, params, options) {
        ...
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), eval_id, run_id, outputItemID), options);
    }
    /**
     * Get a list of output items for an evaluation run.
     */ list(runID, params, options) {
        const { eval_id, ...query } = params;
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), eval_id, runID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options
        });
    }
...
class Runs extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(evalID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), evalID), {
            body,
            ...options
        });
    }
     ...
     */ retrieve(runID, params, options) {
        ...
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), eval_id, runID), options);
    }
    /**
     * Get a list of runs for an evaluation.
     */ list(evalID) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), evalID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options
        });
    }
     ...
     */ delete(runID, params, options) {
        const { eval_id } = params;
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject3(), eval_id, runID), options);
    }
    /**
     * Cancel an ongoing evaluation run.
     */ cancel(runID, params, options) {
        const { eval_id } = params;
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject4(), eval_id, runID), options);
    }
    constructor(){
        super(...arguments);
...
class Evals extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(evalID, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), evalID), options);
    }
    /**
     * Update certain properties of an evaluation.
     */ update(evalID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), evalID), {
            body,
            ...options
        });
    }
     ...
     */ delete(evalID, options) {
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), evalID), options);
    }
    constructor(){
        super(...arguments);
...
class Files extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(fileID, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), fileID), options);
    }
    /**
     ...
     */ delete(fileID, options) {
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), fileID), options);
    }
    /**
     * Returns the contents of the specified file.
     */ content(fileID, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), fileID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    Accept: 'application/binary'
...
class Permissions extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(fineTunedModelCheckpoint, body, options) {
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), fineTunedModelCheckpoint), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Page"], {
            body,
            method: 'post',
            ...options
        });
     ...
     */ retrieve(fineTunedModelCheckpoint) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), fineTunedModelCheckpoint), {
            query,
            ...options
        });
    }
     ...
     */ delete(permissionID, params, options) {
        ...
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), fine_tuned_model_checkpoint, permissionID), options);
    }
...
class Checkpoints extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ list(fineTuningJobID) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), fineTuningJobID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options
        });
    }
...
class Jobs extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(fineTuningJobID, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), fineTuningJobID), options);
    }
    /**
     ...
     */ cancel(fineTuningJobID, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), fineTuningJobID), options);
    }
    /**
     ...
     */ listEvents(fineTuningJobID) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), fineTuningJobID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options
        });
    }
     ...
     */ pause(fineTuningJobID, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject3(), fineTuningJobID), options);
    }
    /**
     ...
     */ resume(fineTuningJobID, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject4(), fineTuningJobID), options);
    }
    constructor(){
        super(...arguments);
...
class Models extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(model, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), model), options);
    }
    /**
     ...
     */ delete(model, options) {
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), model), options);
    }
    ...
    [(_ResponseStream_params = new WeakMap(), _ResponseStream_currentResponseSnapshot = new WeakMap(), _ResponseStream_finalResponse = new WeakMap(), _ResponseStream_instances = new WeakSet(), _ResponseStream_beginRequest = function _ResponseStream_beginRequest() {
            ...
            case 'response.output_text.delta':
                {
                    ...
                    if (!output) {
                        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing output at index ".concat(event.output_index));
                    }
                    if (output.type === 'message') {
                        const content = output.content[event.content_index];
                        if (!content) {
                            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("missing content at index ".concat(event.content_index));
                        }
                        if (content.type !== 'output_text') {
                            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("expected content to be 'output_text', got ".concat(content.type));
                        }
        ...
        if (!snapshot) {
            if (event.type !== 'response.created') {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("When snapshot hasn't been set yet, expected 'response.created' event, got ".concat(event.type));
            }
...
class InputItems extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ list(responseID) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), responseID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options
        });
    }
...
class Responses extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
    ...
    retrieve(responseID) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        var _query_stream;
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), responseID), {
            query,
            ...options,
     ...
     */ delete(responseID, options) {
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), responseID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    Accept: '*/*'
     ...
     */ cancel(responseID, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), responseID), options);
    }
    constructor(){
        super(...arguments);
...
class Parts extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(uploadID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), uploadID), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$uploads$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["multipartFormRequestOptions"])({
            body,
            ...options
        }, this._client));
    }
...
class Uploads extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ cancel(uploadID, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), uploadID), options);
    }
    /**
     * Completes the
     ...
     */ complete(uploadID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), uploadID), {
            body,
            ...options
        });
    }
...
class FileBatches extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ create(vectorStoreID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), vectorStoreID), {
            body,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ retrieve(batchID, params, options) {
        ...
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), vector_store_id, batchID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ cancel(batchID, params, options) {
        const { vector_store_id } = params;
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), vector_store_id, batchID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ listFiles(batchID, params, options) {
        ...
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject3(), vector_store_id, batchID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
...
class Files extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(fileID, params, options) {
        const { vector_store_id } = params;
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), vector_store_id, fileID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ update(fileID, params, options) {
        ...
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), vector_store_id, fileID), {
            body,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ list(vectorStoreID) {
        let query = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 ? arguments[2] : void 0;
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject3(), vectorStoreID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CursorPage"], {
            query,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ delete(fileID, params, options) {
        const { vector_store_id } = params;
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject4(), vector_store_id, fileID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ content(fileID, params, options) {
        const { vector_store_id } = params;
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject5(), vector_store_id, fileID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Page"], {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
...
class VectorStores extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ retrieve(vectorStoreID, options) {
        return this._client.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject(), vectorStoreID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ update(vectorStoreID, body, options) {
        return this._client.post((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject1(), vectorStoreID), {
            body,
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
     ...
     */ delete(vectorStoreID, options) {
        return this._client.delete((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject2(), vectorStoreID), {
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
                {
                    'OpenAI-Beta': 'assistants=v2'
     ...
     */ search(vectorStoreID, body, options) {
        return this._client.getAPIList((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$path$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["path"])(_templateObject3(), vectorStoreID), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$pagination$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Page"], {
            body,
            method: 'post',
            ...options,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$headers$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildHeaders"])([
...
class Webhooks extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$resource$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIResource"] {
     ...
     */ async unwrap(payload, headers) {
        let secret = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : this._client.webhookSecret, tolerance = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 300;
...
;
;
var _readEnv, _readEnv1, _readEnv2;
class OpenAI {
    /**
    ...
    defaultIdempotencyKey() {
        return "stainless-node-retry-".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$uuid$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uuid4"])());
    }
    ...
    async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loggerFor"])(this).debug("[".concat(requestLogID, "] sending request"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRequestDetails"])({
            retryOfRequestLogID,
        ...
        if (response instanceof Error) {
            ...
            if (retriesRemaining) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loggerFor"])(this).info("[".concat(requestLogID, "] connection ").concat(isTimeout ? 'timed out' : 'failed', " - ").concat(retryMessage));
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loggerFor"])(this).debug("[".concat(requestLogID, "] connection ").concat(isTimeout ? 'timed out' : 'failed', " (").concat(retryMessage, ")"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRequestDetails"])({
                    retryOfRequestLogID,
                    url,
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loggerFor"])(this).info("[".concat(requestLogID, "] connection ").concat(isTimeout ? 'timed out' : 'failed', " - error; no more retries left"));
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loggerFor"])(this).debug("[".concat(requestLogID, "] connection ").concat(isTimeout ? 'timed out' : 'failed', " (error; no more retries left)"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRequestDetails"])({
                retryOfRequestLogID,
                url,
                durationMs: headersTime - startTime,
                message: response.message
        ...
        if (!response.ok) {
            ...
            if (retriesRemaining && shouldRetry) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loggerFor"])(this).info("".concat(responseInfo, " - ").concat(retryMessage));
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loggerFor"])(this).debug("[".concat(requestLogID, "] response error (").concat(retryMessage, ")"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRequestDetails"])({
                    retryOfRequestLogID,
                    url: response.url,
                    status: response.status,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loggerFor"])(this).debug("[".concat(requestLogID, "] response start"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRequestDetails"])({
            retryOfRequestLogID,
            url: response.url,
            status: response.status,
            headers: response.headers,
    ...
    async buildRequest(inputOptions) {
        ...
        var _this_fetchOptions, _options_fetchOptions;
        const req = {
            method,
            headers: reqHeaders,
            ...options.signal && {
            ...
            ...(_this_fetchOptions = this.fetchOptions) !== null && _this_fetchOptions !== void 0 ? _this_fetchOptions : {},
    ...
    async buildHeaders(param) {
        let { options, method, bodyHeaders, retryCount } = param;
    ...
    buildBody(param) {
        let { options: { body, headers: rawHeaders } } = param;
        if (!body) {
            return {
     ...
     */ constructor({ baseURL = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$env$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readEnv"])('OPENAI_BASE_URL'), apiKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$env$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readEnv"])('OPENAI_API_KEY'), organization = (_readEnv = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$env$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readEnv"])('OPENAI_ORG_ID')) !== null && _readEnv !== void 0 ? _readEnv : null, project = (_readEnv1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$env$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readEnv"])('OPENAI_PROJECT_ID')) !== null && _readEnv1 !== void 0 ? _readEnv1 : null, webhookSecret = (_readEnv2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$env$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readEnv"])('OPENAI_WEBHOOK_SECRET')) !== null && _readEnv2 !== void 0 ? _readEnv2 : null, ...opts } = {}){
        ...
        var _options_timeout;
        this.timeout = (_options_timeout = options.timeout) !== null && _options_timeout !== void 0 ? _options_timeout : _a.DEFAULT_TIMEOUT /* 10 minutes */ ;
        var _options_logger;
        this.logger = (_options_logger = options.logger) !== null && _options_logger !== void 0 ? _options_logger : console;
        const defaultLogLevel = 'warn';
        // Set default logLevel early so that we can log a warning in parseLogLevel.
        this.logLevel = defaultLogLevel;
        var _parseLogLevel, _ref;
        this.logLevel = (_ref = (_parseLogLevel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLogLevel"])(options.logLevel, 'ClientOptions.logLevel', this)) !== null && _parseLogLevel !== void 0 ? _parseLogLevel : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$log$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLogLevel"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$utils$2f$env$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readEnv"])('OPENAI_LOG'), "process.env['OPENAI_LOG']", this)) !== null && _ref !== void 0 ? _ref : defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        var _options_maxRetries;
        this.maxRetries = (_options_maxRetries = options.maxRetries) !== null && _options_maxRetries !== void 0 ? _options_maxRetries : 2;
        var _options_fetch;
        this.fetch = (_options_fetch = options.fetch) !== null && _options_fetch !== void 0 ? _options_fetch : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$internal$2f$shims$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultFetch"]();
    ...
    async _getAzureADToken() {
        if (typeof this._azureADTokenProvider === 'function') {
            ...
            if (!token || typeof token !== 'string') {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$core$2f$error$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OpenAIError"]("Expected 'azureADTokenProvider' argument to return a string but it returned ".concat(token));
            }
            return token;
        }
        return undefined;
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/Options.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/util.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/Refs.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$Options$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/openai/_vendor/zod-to-json-schema/Options.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$util$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/openai/_vendor/zod-to-json-schema/util.mjs [app-client] (ecmascript)");
;
;
const getRefs = (options)=>{
    const _options = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$Options$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultOptions"])(options);
    ...
    return {
        ...
        seen: new Map(Object.entries(_options.definitions).map((param)=>{
            let [name, def] = param;
            return [
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$util$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodDef"])(def),
                {
                    def: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$util$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodDef"])(def),
                    path: [
                        ..._options.basePath,
                        _options.definitionPath,
                        name
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/errorMessages.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/any.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/array.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/openai/_vendor/zod-to-json-schema/parseDef.mjs [app-client] (ecmascript)");
;
;
;
function parseArrayDef(def, refs) {
    ...
    if (((_def_type = def.type) === null || _def_type === void 0 ? void 0 : (_def_type__def = _def_type._def) === null || _def_type__def === void 0 ? void 0 : _def_type__def.typeName) !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodAny) {
        res.items = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.type._def, {
            ...refs,
            currentPath: [
                ...refs.currentPath,
                'items'
    ...
    if (def.minLength) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(res, 'minItems', def.minLength.value, def.minLength.message, refs);
    }
    if (def.maxLength) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(res, 'maxItems', def.maxLength.value, def.maxLength.message, refs);
    }
    if (def.exactLength) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(res, 'minItems', def.exactLength.value, def.exactLength.message, refs);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(res, 'maxItems', def.exactLength.value, def.exactLength.message, refs);
    }
    return res;
} //# sourceMappingURL=array.mjs.map
}),
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/bigint.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        switch(check.kind){
            case 'min':
                if (refs.target === 'jsonSchema7') {
                    if (check.inclusive) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(res, 'minimum', check.value, check.message, refs);
                    } else {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(res, 'exclusiveMinimum', check.value, check.message, refs);
                    }
                } else {
                    if (!check.inclusive) {
            ...
            case 'max':
                if (refs.target === 'jsonSchema7') {
                    if (check.inclusive) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(res, 'maximum', check.value, check.message, refs);
                    } else {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(res, 'exclusiveMaximum', check.value, check.message, refs);
                    }
                } else {
                    if (!check.inclusive) {
                ...
                break;
            case 'multipleOf':
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(res, 'multipleOf', check.value, check.message, refs);
                break;
        }
    }
    return res;
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/boolean.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/branded.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseBrandedDef(_def, refs) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(_def.type._def, refs);
} //# sourceMappingURL=branded.mjs.map
}),
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/catch.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const parseCatchDef = (def, refs)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.innerType._def, refs);
}; //# sourceMappingURL=catch.mjs.map
}),
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/date.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/default.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseDefaultDef(_def, refs) {
    return {
        ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(_def.innerType._def, refs),
        default: _def.defaultValue()
    };
} //# sourceMappingURL=default.mjs.map
}),
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/effects.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseEffectsDef(_def, refs, forceResolution) {
    return refs.effectStrategy === 'input' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(_def.schema._def, refs, forceResolution) : {};
} //# sourceMappingURL=effects.mjs.map
}),
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/enum.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/intersection.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseIntersectionDef(def, refs) {
    const allOf = [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.left._def, {
            ...refs,
            currentPath: [
                ...refs.currentPath,
                'allOf',
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.right._def, {
            ...refs,
            currentPath: [
                ...refs.currentPath,
                'allOf',
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/literal.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/string.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
                ...
                case 'base64':
                    {
                        switch(refs.base64Strategy){
                            ...
                            case 'contentEncoding:base64':
                                {
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(res, 'contentEncoding', 'base64', check.message, refs);
                                    break;
                                }
                            case 'pattern:zod':
                                {
...
const addFormat = (schema, value, message, refs)=>{
    ...
    if (schema.format || ((_schema_anyOf = schema.anyOf) === null || _schema_anyOf === void 0 ? void 0 : _schema_anyOf.some((x)=>x.format))) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(schema, 'format', value, message, refs);
    }
};
const addPattern = (schema, regex, message, refs)=>{
    ...
    if (schema.pattern || ((_schema_allOf = schema.allOf) === null || _schema_allOf === void 0 ? void 0 : _schema_allOf.some((x)=>x.pattern))) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(schema, 'pattern', processRegExp(regex, refs), message, refs);
    }
};
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/record.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseRecordDef(def, refs) {
    ...
    if (refs.target === 'openApi3' && ((_def_keyType = def.keyType) === null || _def_keyType === void 0 ? void 0 : _def_keyType._def.typeName) === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodEnum) {
        return {
            ...
            properties: def.keyType._def.values.reduce((acc, key)=>{
                ...
                return {
                    ...acc,
                    [key]: (_parseDef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.valueType._def, {
                        ...refs,
                        currentPath: [
                            ...refs.currentPath,
                            'properties',
    ...
    const schema = {
        type: 'object',
        additionalProperties: (_parseDef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.valueType._def, {
            ...refs,
            currentPath: [
                ...refs.currentPath,
    ...
    if (((_def_keyType1 = def.keyType) === null || _def_keyType1 === void 0 ? void 0 : _def_keyType1._def.typeName) === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodString && ((_def_keyType__def_checks = def.keyType._def.checks) === null || _def_keyType__def_checks === void 0 ? void 0 : _def_keyType__def_checks.length)) {
        const keyType = Object.entries((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$string$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseStringDef"])(def.keyType._def, refs)).reduce((acc, param)=>{
            let [key, value] = param;
            return key === 'type' ? acc : {
                ...acc,
                [key]: value
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/map.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/openai/_vendor/zod-to-json-schema/parseDef.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$record$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/record.mjs [app-client] (ecmascript)");
;
;
function parseMapDef(def, refs) {
    if (refs.mapStrategy === 'record') {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$record$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseRecordDef"])(def, refs);
    }
    const keys = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.keyType._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            'items',
    ...
    const values = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.valueType._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            'items',
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/nativeEnum.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/never.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/null.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/union.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const asAnyOf = (def, refs)=>{
    const anyOf = (def.options instanceof Map ? Array.from(def.options.values()) : def.options).map((x, i)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(x._def, {
            ...refs,
            currentPath: [
                ...refs.currentPath,
                'anyOf',
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/nullable.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseNullableDef(def, refs) {
    if ([
        ...
        if (refs.target === 'openApi3' || refs.nullableStrategy === 'property') {
            return {
                type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$union$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["primitiveMappings"][def.innerType._def.typeName],
                nullable: true
            };
        }
        return {
            type: [
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$union$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["primitiveMappings"][def.innerType._def.typeName],
                'null'
            ]
        };
    }
    if (refs.target === 'openApi3') {
        const base = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.innerType._def, {
            ...refs,
            currentPath: [
                ...refs.currentPath
            ]
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/number.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseNumberDef(def, refs) {
    ...
    for (const check of def.checks){
        switch(check.kind){
            case 'int':
                res.type = 'integer';
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addErrorMessage"])(res, 'type', check.message, refs);
                break;
            case 'min':
                if (refs.target === 'jsonSchema7') {
                    if (check.inclusive) {
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/object.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function decideAdditionalProperties(def, refs) {
    if (refs.removeAdditionalStrategy === 'strict') {
        var _parseDef;
        return def.catchall._def.typeName === 'ZodNever' ? def.unknownKeys !== 'strict' : (_parseDef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.catchall._def, {
            ...refs,
            currentPath: [
                ...refs.currentPath,
                'additionalProperties'
        ...
        var _parseDef1;
        return def.catchall._def.typeName === 'ZodNever' ? def.unknownKeys === 'passthrough' : (_parseDef1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.catchall._def, {
            ...refs,
            currentPath: [
                ...refs.currentPath,
                'additionalProperties'
...
function parseObjectDef(def, refs) {
    const result = {
        ...
        ...Object.entries(def.shape()).reduce((acc, param)=>{
            ...
            const parsedDef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(propDef._def, {
                ...refs,
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/optional.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const parseOptionalDef = (def, refs)=>{
    if (refs.propertyPath && refs.currentPath.slice(0, refs.propertyPath.length).toString() === refs.propertyPath.toString()) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.innerType._def, {
            ...refs,
            currentPath: refs.currentPath
        });
    }
    const innerSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.innerType._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            'anyOf',
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/pipeline.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const parsePipelineDef = (def, refs)=>{
    if (refs.pipeStrategy === 'input') {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.in._def, refs);
    } else if (refs.pipeStrategy === 'output') {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.out._def, refs);
    }
    const a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.in._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            'allOf',
    ...
    const b = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.out._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            'allOf',
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/promise.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parsePromiseDef(def, refs) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.type._def, refs);
} //# sourceMappingURL=promise.mjs.map
}),
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/set.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseSetDef(def, refs) {
    const items = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.valueType._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            'items'
    ...
    if (def.minSize) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(schema, 'minItems', def.minSize.value, def.minSize.message, refs);
    }
    if (def.maxSize) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$errorMessages$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setResponseValueAndErrors"])(schema, 'maxItems', def.maxSize.value, def.maxSize.message, refs);
    }
    return schema;
} //# sourceMappingURL=set.mjs.map
}),
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/tuple.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseTupleDef(def, refs) {
    if (def.rest) {
        return {
            ...
            items: def.items.map((x, i)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(x._def, {
                    ...refs,
                    currentPath: [
                        ...refs.currentPath,
                        'items',
            ...
            additionalItems: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(def.rest._def, {
                ...refs,
                currentPath: [
                    ...refs.currentPath,
                    'additionalItems'
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/undefined.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/unknown.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parsers/readonly.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/parseDef.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseDef(def, refs) {
    ...
    if (refs.override) {
        ...
        if (overrideResult !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$Options$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ignoreOverride"]) {
...
const selectParser = (def, typeName, refs, forceResolution)=>{
    switch(typeName){
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodString:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$string$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseStringDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodNumber:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$number$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNumberDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodObject:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$object$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseObjectDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodBigInt:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$bigint$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseBigintDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodBoolean:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$boolean$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseBooleanDef"])();
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodDate:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$date$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDateDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodUndefined:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$undefined$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseUndefinedDef"])();
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodNull:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$null$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNullDef"])(refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodArray:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$array$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseArrayDef"])(def, refs);
        ...
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodDiscriminatedUnion:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$union$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseUnionDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodIntersection:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$intersection$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseIntersectionDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodTuple:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$tuple$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseTupleDef"])(def, refs);
        ...
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodLiteral:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$literal$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLiteralDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodEnum:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$enum$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseEnumDef"])(def);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodNativeEnum:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$nativeEnum$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNativeEnumDef"])(def);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodNullable:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$nullable$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNullableDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodOptional:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$optional$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseOptionalDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodMap:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$map$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseMapDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodSet:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$set$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseSetDef"])(def, refs);
        ...
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodPromise:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$promise$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePromiseDef"])(def, refs);
        ...
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodNever:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$never$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNeverDef"])();
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodEffects:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$effects$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseEffectsDef"])(def, refs, forceResolution);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodAny:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$any$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseAnyDef"])();
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodUnknown:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$unknown$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseUnknownDef"])();
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodDefault:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$default$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDefaultDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodBranded:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$branded$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseBrandedDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodReadonly:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$readonly$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseReadonlyDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodCatch:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$catch$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseCatchDef"])(def, refs);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodFirstPartyTypeKind"].ZodPipeline:
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parsers$2f$pipeline$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePipelineDef"])(def, refs);
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/zodToJsonSchema.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/openai/_vendor/zod-to-json-schema/parseDef.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$Refs$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/openai/_vendor/zod-to-json-schema/Refs.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$util$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/openai/_vendor/zod-to-json-schema/util.mjs [app-client] (ecmascript)");
;
;
;
const zodToJsonSchema = (schema, options)=>{
    const refs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$Refs$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRefs"])(options);
    ...
    var _parseDef;
    const main = (_parseDef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])(schema._def, name === undefined ? refs : {
        ...refs,
        currentPath: [
            ...refs.basePath,
            refs.definitionPath,
    ...
    const definitions = (()=>{
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$util$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isEmptyObj"])(refs.definitions)) {
            return undefined;
        }
        const definitions = {};
        ...
        for(let i = 0; i < 500; i++){
            ...
            for (const [key, schema] of newDefinitions){
                var _parseDef;
                definitions[key] = (_parseDef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$parseDef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDef"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$util$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodDef"])(schema), {
                    ...refs,
                    currentPath: [
                        ...refs.basePath,
                        refs.definitionPath,
...
"[project]/node_modules/openai/_vendor/zod-to-json-schema/index.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
;
;
const __TURBOPACK__default__export__ = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$zodToJsonSchema$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodToJsonSchema"];
 //# sourceMappingURL=index.mjs.map
}),
"[project]/node_modules/openai/helpers/zod.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function zodToJsonSchema(schema, options) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$_vendor$2f$zod$2d$to$2d$json$2d$schema$2f$zodToJsonSchema$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodToJsonSchema"])(schema, {
...
function zodResponseFormat(zodObject, name, props) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$parser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeParseableResponseFormat"])({
        type: 'json_schema',
        json_schema: {
            ...props,
            name,
...
function zodTextFormat(zodObject, name, props) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$parser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeParseableTextFormat"])({
        type: 'json_schema',
        ...props,
        name,
        strict: true,
...
function zodFunction(options) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$parser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeParseableTool"])({
        type: 'function',
        function: {
            name: options.name,
...
function zodResponsesFunction(options) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$lib$2f$ResponsesParser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeParseableResponseTool"])({
        type: 'function',
        name: options.name,
        parameters: zodToJsonSchema(options.parameters, {
            name: options.name
...
//# sourceMappingURL=node_modules_openai_7b7160bf._.js.map