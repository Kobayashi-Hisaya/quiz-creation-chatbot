...
class ChatService {
    ...
    clearHistory() {
        this.conversationHistory = [
            new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$core$2f$dist$2f$messages$2f$system$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SystemMessage"](this.getCurrentSystemMessage())
        ];
    }
    // 対話履歴を取得するメソッド（デバッグ用）
    getHistory() {
    ...
    getConversationHistory() {
        return this.conversationHistory.map((msg)=>{
            let role = 'system';
            if (msg instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$core$2f$dist$2f$messages$2f$human$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HumanMessage"]) role = 'user';
            else if (msg instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$core$2f$dist$2f$messages$2f$ai$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AIMessage"]) role = 'assistant';
            else if (msg instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$core$2f$dist$2f$messages$2f$system$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SystemMessage"]) role = 'system';
            return {
                role,
                content: msg.content
            };
    ...
    constructor(){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "currentLearningTopic", void 0);
...
const ChatContainer = ()=>{
    ...
    const handleSendMessage = async (content)=>{
        ...
        setIsLoading(true);
        try {
            const botResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(content);
            const botMessage = {
    ...
    const handleClearHistory = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].clearHistory();
        setMessages([]);
...
_s(ChatContainer, "SZtR+qwOo0SYfcLLrbuTERESoa0=");
_c = ChatContainer;
var _c;
...
"[project]/src/components/ProblemInput.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var _s = __turbopack_context__.k.signature();
;
const ProblemInput = (param)=>{
    let { onProblemChange, initialValue = '' } = param;
    _s();
    const [problem, setProblem] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialValue);
    // initialValueが変更されたら内部状態を更新
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProblemInput.useEffect": ()=>{
...
_s(ProblemInput, "BshBPax/ImeRs5rYeNc+oXZOyag=");
_c = ProblemInput;
var _c;
__turbopack_context__.k.register(_c, "ProblemInput");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const CodeEditor = (param)=>{
    let { value, onChange, language, onLanguageChange } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
            height: "100%",
            display: "flex",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ProblemInput$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ProblemInput.tsx [app-client] (ecmascript)");
...
const RightPanel = ()=>{
    ...
    const { problemData, setProblemData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$ProblemContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProblem"])();
    // ProblemContextから初期値を設定
    const [language, setLanguage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(problemData.language || "typescript");
    const [code, setCode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(problemData.code || DEFAULT_CODE_TEMPLATES[problemData.language || "typescript"]);
    const [problem, setProblem] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(problemData.problem || "");
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ProblemInput$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProblemInput"], {
...
_s(RightPanel, "k6hfxsMGn0heY2ej4u0UO/529rE=", false, function() {
    return [
...
"[project]/src/components/LearningTopicSelector.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var _s = __turbopack_context__.k.signature();
;
const LearningTopicSelector = (param)=>{
    let { isOpen, onSelect } = param;
    _s();
    const [selectedTopic, setSelectedTopic] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('制御構造');
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        selectedTopic === 'その他' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                            type: "text",
                            value: customTopic,
...
_s(LearningTopicSelector, "I/hMm+ATb6R/u4pOe2rAqFqP4PY=");
_c = LearningTopicSelector;
var _c;
__turbopack_context__.k.register(_c, "LearningTopicSelector");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/create-quiz/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LearningTopicSelector$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/LearningTopicSelector.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$ProblemContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/ProblemContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/chatService.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
const HomePage = ()=>{
    _s();
    const { problemData, setLearningTopic } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$ProblemContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProblem"])();
    const [showTopicSelector, setShowTopicSelector] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [hasSelectedTopic, setHasSelectedTopic] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleTopicSelect = (topic)=>{
        setLearningTopic(topic);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].setLearningTopic(topic);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ChatContainer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChatContainer"], {}, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LearningTopicSelector$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LearningTopicSelector"], {
...
_s(HomePage, "YpXM4bRBuumeuUdeBlH3M2830CM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$ProblemContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProblem"]
    ];
});
...
//# sourceMappingURL=_12cdb152._.js.map